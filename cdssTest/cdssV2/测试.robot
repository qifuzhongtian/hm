...
#     log    ${aj}
#     Should Contain    ${aj[:10]}    子宫颈癌跑;;


1.连接数据库
    Connect To Database Using Custom Params    pymysql    user='enginer', passwd='dataisbest', host='10.117.64.153', port=3306,db='his'
    ${a}    Query    select * from doctor
    log    ${a[0]}
