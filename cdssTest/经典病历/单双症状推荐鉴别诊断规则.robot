...
12行-急性腹痛,推出诊断:急性胃肠炎,消化性溃疡,急性胆囊炎,急性阑尾炎,急性女性盆腔炎,流产,卵巢扭转,异位妊娠,肾绞痛,肠梗阻,急性腹膜炎,消化道穿孔,肾盂肾炎,急性出血坏死性肠炎,肝炎,炎症性肠病,缺血性肠病,主动脉夹层,肠扭转,自发性腹膜炎,腹主动脉瘤破裂,门静脉血栓形成,腹壁挫伤,带状疱疹,胸膜炎,便秘,细菌性食物中毒
        [Documentation]    断言:""
        ${Assessment}    Set Variable
        ${Subjective}    Set Variable    急性腹痛
        ${assert}    Create List    急性胃肠炎    消化性溃疡    急性胆囊炎    急性阑尾炎    急性女性盆腔炎    流产    卵巢扭转    异位妊娠    肾绞痛    肠梗阻    急性腹膜炎    消化道穿孔    肾盂肾炎    急性出血坏死性肠炎    肝炎    炎症性肠病    缺血性肠病    主动脉夹层    肠扭转    自发性腹膜炎    腹主动脉瘤破裂    门静脉血栓形成    腹壁挫伤    带状疱疹    胸膜炎    便秘    细菌性食物中毒
        [Setup]    Run Keywords    获取时间戳
        ...    AND    获取随机数
        ${getRes}    智能推荐    userGuid=${timestamp}${random}    serialNumber=${timestamp}${random}    patientName=tester    pageSource=2
        ...    doctorGuid=1    doctorName=hmkj    admissionTime=2018-12-12    inpatientDepartment=儿科
...
103行-黄疸,推出诊断:新生儿生理性黄疸,新生儿病理性黄疸,自身免疫性溶血性贫血,新生儿红细胞增多症,遗传性球形红细胞增多症,先天性胆管闭塞性黄疸,先天性葡萄糖醛酸转移酶缺乏症,新生儿肝炎,甲状腺功能减退症
        ...
        ${getRes}    智能推荐    userGuid=${timestamp}${random}    serialNumber=${timestamp}${random}    patientName=tester    pageSource=2
        ...    doctorGuid=1    doctorName=hmkj    admissionTime=2018-12-12    inpatientDepartment=儿科
        ...    patientInfo={"gender":"1","age":"28","ageType":"天","maritalStatus":"1","pregnancyStatus":"0"}
        ...    physicalSign={"bodyTempr": "","heartRate": "","lowBldPress": "","highBldPress": ""}
        ...    definiteDiagnosis=
        ...    progressNoteList={"doctorGuid":"2222","msgType":"2","messageList":[{"key":"主诉","value":"${Subjective}"},{"key":"诊断依据及鉴别诊断","value":""},{"key":"病例特点","value":""},{"key":"出院医嘱","value":""},{"key": "诊断依据及鉴别诊断1","value":""},{"key":"既往史","value":""},{"key":"初步诊断","value":"${Assessment}"},{"key":"辅助检查","value":""}],"progressType":"2","progressGuid":"22222","recordTime":""}
        ...    deleteProgressNoteList={"progressGuid":"","progressType":"","doctorGid":"","recordTime":""}
...
143行-发育迟缓,推出诊断:青春期延迟,甲状腺功能亢进症,特纳综合征,神经性厌食,低促性腺激素性腺功能减退症,下丘脑综合征,垂体肿物,糖尿病,肾衰竭,囊性纤维化病,乳糜泻,高催乳素血症,先天性肾上腺皮质增生症,库欣综合征,药物相关性青春期发育迟缓,放射性损伤,生长激素缺乏症,卵巢功能障碍,甲状腺功能减退症,单纯性性腺发育不全,睾丸下降不全
        ...
        ${getRes}    智能推荐    userGuid=${timestamp}${random}    serialNumber=${timestamp}${random}    patientName=tester    pageSource=2
        ...    doctorGuid=1    doctorName=hmkj    admissionTime=2018-12-12    inpatientDepartment=儿科
        ...    patientInfo={"gender":"1","age":"1","ageType":"岁","maritalStatus":"1","pregnancyStatus":"0"}
        ...    physicalSign={"bodyTempr": "","heartRate": "","lowBldPress": "","highBldPress": ""}
        ...    definiteDiagnosis=
        ...    progressNoteList={"doctorGuid":"2222","msgType":"2","messageList":[{"key":"主诉","value":"${Subjective}"},{"key":"诊断依据及鉴别诊断","value":""},{"key":"病例特点","value":""},{"key":"出院医嘱","value":""},{"key": "诊断依据及鉴别诊断1","value":""},{"key":"既往史","value":""},{"key":"初步诊断","value":"${Assessment}"},{"key":"辅助检查","value":""}],"progressType":"2","progressGuid":"22222","recordTime":""}
        ...    deleteProgressNoteList={"progressGuid":"","progressType":"","doctorGid":"","recordTime":""}
...
216行-发热+黄疸,推出诊断:自身免疫性溶血性贫血
        ...
        ${getRes}    智能推荐    userGuid=${timestamp}${random}    serialNumber=${timestamp}${random}    patientName=tester    pageSource=2
        ...    doctorGuid=1    doctorName=hmkj    admissionTime=2018-12-12    inpatientDepartment=儿科
        ...    patientInfo={"gender":"1","age":"27","ageType":"天","maritalStatus":"1","pregnancyStatus":"0"}
        ...    physicalSign={"bodyTempr": "","heartRate": "","lowBldPress": "","highBldPress": ""}
        ...    definiteDiagnosis=
        ...    progressNoteList={"doctorGuid":"2222","msgType":"2","messageList":[{"key":"主诉","value":"${Subjective}"},{"key":"诊断依据及鉴别诊断","value":""},{"key":"病例特点","value":""},{"key":"出院医嘱","value":""},{"key": "诊断依据及鉴别诊断1","value":""},{"key":"既往史","value":""},{"key":"初步诊断","value":"${Assessment}"},{"key":"辅助检查","value":""}],"progressType":"2","progressGuid":"22222","recordTime":""}
        ...    deleteProgressNoteList={"progressGuid":"","progressType":"","doctorGid":"","recordTime":""}
