...
尿路感染18岁以下-主诉:女，12岁，尿频、尿急，尿液外观浑浊就诊。既往曾患过3次尿道炎，推荐疑似诊断:尿路感染
    [Documentation]    断言:""
...
尿路感染18岁以下-点击疑似诊断或手动输入：尿路感染，推荐检查：尿细菌计数、尿细菌培养+药敏、血常规、泌尿系超声
    [Documentation]    断言:""
    # ${timestamp}    Get Time    epoch
    ${assert}    Create List    尿细菌培养+药敏    尿细菌计数    泌尿系超声    血常规
