...
痛风-病史：男性，40岁，既往有“高尿酸血症”史。饮酒后反复发作足趾、膝关节疼痛、肿胀、活动障碍1年，加重2周，体型肥胖，推荐疑似诊断:痛风
    [Documentation]    断言:""
...
痛风-点击疑似诊断或手动输入：痛风，推荐检查:关节双能CT、肾功能、关节腔穿刺、尿尿 酸、关节X线、腹部超声、泌尿系超声、血脂 检查、血糖、心电图
    [Documentation]    断言:""
    # ${timestamp}    Get Time    epoch
    ${assert}    Create List    肾功能    尿尿酸    关节X线    关节双能CT    关节腔穿刺    血糖    血脂检查    心电图    泌尿系超声    腹部超声
