...
便秘（小儿）-主诉:男孩儿，6岁，排便困难、便次<3次/周、排便为干球状便或硬便、排便需要手法帮助，推荐疑似诊断:便秘
    [Documentation]    断言:""
    # ${timestamp}    Get Time    epoch
    ${Assessment}    Set Variable
    ${Subjective}    Set Variable    男孩儿，6岁，排便困难、便次<3次/周、排便为干球状便或硬便、排便需要手法帮助
...
便秘（小儿）-点击疑似诊断或手动输入：便秘，推荐检查：肛门检查、直肠指检、神经系统检查、腹部X线
    [Documentation]    断言:""
    # ${timestamp}    Get Time    epoch
    ${assert}    Create List    腹部X线    直肠指检    肛门检查    神经系统检查
...
便秘（小儿）-点击疑似诊断或手动输入：便秘，推荐治疗：一般治疗、行为调整、非嵌塞性便秘药物治疗、非嵌塞性便秘维持治疗
    [Documentation]    断言:""
    # ${timestamp}    Get Time    epoch
    ${assert}    Create List    行为调整    一般治疗    非嵌塞性便秘药物治疗    非嵌塞性便秘维持治疗
    ${Assessment}    Set Variable    便秘
    ${Subjective}    Set Variable    男孩儿，6岁，排便困难、便次<3次/周、排便为干球状便或硬便、排便需要手法帮助
    [Setup]    Run Keywords    获取时间戳
    ...    AND    获取随机数
