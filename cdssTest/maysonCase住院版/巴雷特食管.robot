...
巴雷特食管-主诉:男，59岁，持续反胃数月，反酸3个月，呃逆，上腹部不适，体重减轻，推荐疑似诊断:巴雷特食管
    [Documentation]    断言:""
...
巴雷特食管-点击疑似诊断或手动输入：巴雷特食管，推荐检查：食管胃十二指肠镜检查、胃组织活检
    [Documentation]    断言:""
    # ${timestamp}    Get Time    epoch
...
巴雷特食管-进一步添加并发症：食管腺癌，推荐检查增加：正电子发射计算机断层显像(PET-CT)、胸部CT
    [Documentation]    断言:""
    # ${timestamp}    Get Time    epoch
