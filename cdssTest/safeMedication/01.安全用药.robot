...
1.1 相互作用等级为'谨慎'的两种药,grade=2
    ...
    ${getRes}    安全用药    gender=    age=    ageType=    drugIds=${drugIds}    symptom=    confirmDiagnosis=
...
1.13 人群禁忌等级'症状'为妊娠的药,结果正确
    ...
    ${getRes}    安全用药    gender=    age=    ageType=    drugIds=${drugIds}    symptom=妊娠    confirmDiagnosis=
...
1.14 人群禁忌等级,'性别'为女的药+主诉=备孕,结果正确
    ...
    ${getRes}    安全用药    gender=    age=4381    ageType=天    drugIds=${drugIds}    symptom=备孕    confirmDiagnosis=
...
1.15 人群禁忌等级,ageType=岁,'年龄'=10岁,结果正确
    ...
    ${drugIds}    Create List    579
    ${getRes}    安全用药    gender=    age=10    ageType=岁    drugIds=${drugIds}    symptom=    confirmDiagnosis=
...
1.16 人群禁忌等级,ageType=月,'年龄mix_day'=30,结果正确
    ...
    ${getRes}    安全用药    gender=    age=30    ageType=天    drugIds=${drugIds}    symptom=    confirmDiagnosis=
...
1.17 人群禁忌等级,ageType=月,'年龄min_day'=4380,结果正确
    ...
    ${drugIds}    Create List    139
    ${getRes}    安全用药    gender=    age=4382    ageType=天    drugIds=${drugIds}    symptom=    confirmDiagnosis=
...
1.18 人群禁忌等级,ageType=天,'年龄1-43799',结果正确
    ...
    ${getRes}    安全用药    gender=    age=43799    ageType=天    drugIds=${drugIds}    symptom=    confirmDiagnosis=
...
1.19 人群禁忌等级,年龄+症状,结果正确
    ...
    ${getRes}    安全用药    gender=0    age=22    ageType=岁    drugIds=${drugIds}    symptom=妊娠    confirmDiagnosis=
...
1.20 人群禁忌等级,年龄+性别,结果正确
    ...
    ${getRes}    安全用药    gender=0    age=14600    ageType=天    drugIds=${drugIds}    symptom=    confirmDiagnosis=
...
1.21 人群禁忌等级,年龄+性别+病症,结果正确
    ...
    ${getRes}    安全用药    gender=0    age=43800    ageType=天    drugIds=${drugIds}    symptom=未婚    confirmDiagnosis=
...
1.22 人群禁忌等级,用药没有人群禁忌,结果正确,断言 tabooList[]
    ...
    ${getRes}    安全用药    gender=0    age=2459    ageType=天    drugIds=${drugIds}    symptom=未婚    confirmDiagnosis=
...
1.23 高血压用药重复,repetitionList_diseaseName显示为'高血压用药重复'
    ...
    ${getRes}    安全用药    gender=1    age=    ageType=    drugIds=${drugIds}    symptom=    confirmDiagnosis=
    Should Be Equal As Strings    ${getRes['body']['repetitionList'][0]['diseaseName']}    高血压

1.23.5 高血压用药重复,用药审核结果为'待审核'
    [Documentation]    断言:"safeStatus=2"
    ${drugIds}    Create List    2726    2391
    ${getRes}    安全用药    gender=1    age=50    ageType=岁    drugIds=${drugIds}    symptom=    confirmDiagnosis=
...
1.24 高血压用药不重复,等级grade为'合理'的药,用药审核结果为'审核通过'
    [Documentation]    断言:"safeStatus=3"
    ${drugIds}    Create List    5647
    ${getRes}    安全用药    gender=    age=55    ageType=岁    drugIds=${drugIds}    symptom=    confirmDiagnosis=
...
1.35 人群禁忌等级grade为'2不适用'的药+高血压用药重复,用药审核结果为'待审核'
    ...
    ${getRes}    安全用药    gender=    age=20    ageType=岁    drugIds=${drugIds}    symptom=    confirmDiagnosis=
    Should Be Equal As Strings    ${getRes['body']['safeStatus']}    2

1.36 高血压用药重复,用药审核结果为'待审核'
    [Documentation]    断言:"safeStatus=2"
    ${drugIds}    Create List    2726    2391
    ${getRes}    安全用药    gender=    age=22    ageType=岁    drugIds=${drugIds}    symptom=    confirmDiagnosis=
    Should Be Equal As Strings    ${getRes['body']['safeStatus']}    2
...
1.37 相互作用=2,高血压用药重复,用药审核结果为'待审核'
    ...
    ${getRes}    安全用药    gender=    age=50    ageType=岁    drugIds=${drugIds}    symptom=    confirmDiagnosis=
    Should Be Equal As Strings    ${getRes['body']['safeStatus']}    2

1.38 相互作用=2,人群禁忌=2,高血压用药重复,用药审核结果为'待审核'
    [Documentation]    断言:"safeStatus=2"
    ${drugIds}    Create List    8126    5714    3517    2726    2391
    ${getRes}    安全用药    gender=0    age=50    ageType=岁    drugIds=${drugIds}    symptom=    confirmDiagnosis=
    Should Be Equal As Strings    ${getRes['body']['safeStatus']}    2
...
1.50 相互作用=0,人群禁忌=0,无高血压重复用药,用药审核结果为'通过'
    ...
    ${getRes}    安全用药    gender=1    age=    ageType=岁    drugIds=${drugIds}    symptom=    confirmDiagnosis=
    Should Be Equal As Strings    ${getRes['body']['safeStatus']}    3
...
1.51 药物禁忌与confirmDiagnosis不匹配,不显示禁忌
    ...
    ${drugIds}    Create List    930
    ${getRes}    安全用药    gender=0    age=22    ageType=    drugIds=${drugIds}    symptom=    confirmDiagnosis=13895
    Should Be Equal As Strings    ${getRes['body']['tabooList']}    []
...
1.52 药物禁忌与confirmDiagnosis匹配,显示禁忌
    ...
    ${drugIds}    Create List    930
    ${getRes}    安全用药    gender=0    age=    ageType=    drugIds=${drugIds}    symptom=    confirmDiagnosis=14234
    Should Be Equal As Strings    ${getRes['body']['tabooList'][0]['description']}    3个月以上孕妇慎用
...
1.53 药物禁忌与主诉匹配,显示禁忌
    ...
    ${drugIds}    Create List    930
    ${getRes}    安全用药    gender=0    age=    ageType=    drugIds=${drugIds}    symptom=怀孕    confirmDiagnosis=
    Should Be Equal As Strings    ${getRes['body']['tabooList'][0]['description']}    3个月以上孕妇慎用
...
1.54 药物禁忌与主诉不匹配,不显示禁忌
    ...
    ${drugIds}    Create List    930
    ${getRes}    安全用药    gender=0    age=22    ageType=    drugIds=${drugIds}    symptom=痛经    confirmDiagnosis=
    Should Be Equal As Strings    ${getRes['body']['tabooList']}    []
