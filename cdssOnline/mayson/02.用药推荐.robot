...
# 保守策略:双抗4.2: 急性非ST段抬高型心肌梗塞+缺血中危+非出血高危,用药推荐包含: 硫酸氢氯吡格雷片 硫酸氢氯吡格雷颗粒
#     [Documentation]    断言:""
#     ${assert}    Create List    硫酸氢氯吡格雷片    硫酸氢氯吡格雷颗粒
#     [Setup]    Run Keywords    获取时间戳
#     ...    AND    获取随机数
...
###############
#####PCI手术:术前－抗血小板治疗  急性非ST段抬高型心肌梗塞     8065    阿司匹林缓释片 1   嚼服  100-300mg   顿服
用药推荐:地西泮片 地西泮膜 复方地西泮片 氯硝西泮片 阿普唑仑片 阿普唑仑胶囊 艾司唑仑片 单盐酸氟西泮胶囊 氯氮卓片 奥沙西泮片 三唑仑片 酒石酸唑吡坦片 酒石酸唑吡坦分散片
    [Documentation]    断言:""
