...
#三无,通过
@{drugIds_interactionList_grade0_tabooList_grade0_repetitionList2}        1360    742    2391    5323
...
#     [Documentation]    断言error:"interactionList[]=空"
#     安全用药    ['body']['interactionList']    []
#     ...    gender=    age=55    ageType=岁    drugIds=${drugIds_interactionList_grade3}    symptom=
...
#     ...    gender=    age=30    ageType=天    drugIds=${drugIds_tabooList_age2}    symptom=
...
#     ...    gender=    age=4382    ageType=天    drugIds=${drugIds_tabooList_age3}    symptom=
...
#     ...    gender=0    age=43800    ageType=天     drugIds=${drugIds_tabooList_age7}    symptom=未婚

# 1.22人群禁忌等级,用药没有人群禁忌,结果正确,断言 tabooList[]
#     [Documentation]    断言error:",tabooList[]=空"
#     安全用药    ['body']['tabooList']    []
#     ...    gender=0    age=2459    ageType=天     drugIds=${drugIds_tabooList_grade0}    symptom=未婚


#高血压
# 1.23高血压用药重复,repetitionList_diseaseName显示为'高血压用药重复'
#     [Documentation]    断言error:"repetitionList--diseaseName=高血压"
#     安全用药    ['body']['repetitionList'][0]['diseaseName']    高血压
#     ...    gender=1    age=    ageType=    drugIds=${drugIds_repetitionList1}    symptom=
...
1.23.6高血压用药重复,用药审核结果为'待审核'
    [Documentation]    断言error:"repetitionList--diseaseName=高血压"
    安全用药    ['body']['safeStatus']    3
    ...    gender=1    age=    ageType=    drugIds=${drugIds_repetitionList2}    symptom=
...
#     [Documentation]    断言error:"safeStatus=1"
#     安全用药    ['body']['safeStatus']    1
#     ...    gender=    age=    ageType=    drugIds=${drugIds_interactionList_tabooList_grade1}    symptom=


# 1.28 相互作用grade=1,人群禁忌grade=2,的药,用药审核结果为'不通过'
#     [Documentation]    断言error:"safeStatus=2"
#     安全用药    ['body']['safeStatus']    1
#     ...    gender=    age=    ageType=    drugIds=${drugIds_interactionList_grade1_tabooList_grade2}    symptom=


# 1.29 相互作用grade=2,人群禁忌grade=1,的药,用药审核结果为'不通过'
#     [Documentation]    断言error:"safeStatus=2"
#     安全用药    ['body']['safeStatus']    1
#     ...    gender=    age=    ageType=    drugIds=${drugIds_interactionList_grade2_tabooList_grade1}    symptom=
...
#     [Documentation]    断言error:"safeStatus=2"
#     安全用药    ['body']['safeStatus']    1
#     ...    gender=    age=    ageType=    drugIds=${drugIds_interactionList_grade1_tabooList_grade0}    symptom=

# 1.32 相互作用grade=0,人群禁忌grade=1,的药,用药审核结果为'不通过'
#     [Documentation]    断言error:"safeStatus=2"
#     安全用药    ['body']['safeStatus']    1
#     ...    gender=    age=    ageType=    drugIds=${drugIds_interactionList_grade0_tabooList_grade1}    symptom=

# 1.33 相互作用grade1,人群禁忌grade=0,有高血压用药重复的药,用药审核结果为'不通过'
#     [Documentation]    断言error:"safeStatus=2"
#     安全用药    ['body']['safeStatus']    1
#     ...    gender=    age=    ageType=    drugIds=${drugIds_interactionList_grade1_tabooList_grade0_repetitionList1}    symptom=
...
#     [Documentation]    断言error:"safeStatus=2"
#     安全用药    ['body']['safeStatus']    2
#     ...    gender=    age=20    ageType=岁    drugIds=${drugIds_tabooList_grade2_repetitionList1}    symptom=

# 1.36 高血压用药重复,用药审核结果为'待审核'
#     [Documentation]    断言error:"safeStatus=2"
#     安全用药    ['body']['safeStatus']    2
#     ...    gender=    age=22    ageType=岁    drugIds=${drugIds_repetitionList1}    symptom=

# 1.36.5 无高血压重复用药,相同分组,用药审核结果为'待审核'
#     [Documentation]    断言error:"safeStatus=2"
#     安全用药    ['body']['safeStatus']    2
#     ...    gender=    age=    ageType=    drugIds=${drugIds_repetitionList3}    symptom=


# 1.37 相互作用=2,高血压用药重复,用药审核结果为'待审核'
#     [Documentation]    断言error:"safeStatus=2"
#     安全用药    ['body']['safeStatus']    2
#     ...    gender=1    age=    ageType=    drugIds=${drugIds_interactionList_grade2_drugIds_repetitionList1}    symptom=

# 1.38 相互作用=2,人群禁忌=2,高血压用药重复,用药审核结果为'待审核'
#     [Documentation]    断言error:"safeStatus=2"
#     安全用药    ['body']['safeStatus']    2
#     ...    gender=0    age=    ageType=    drugIds=${drugIds_interactionList_grade1_tabooList2_repetitionList1}    symptom=
...
#     [Documentation]    断言error:"safeStatus=3"
#     安全用药    ['body']['safeStatus']    3
#     ...    gender=    age=22    ageType=岁    drugIds=${drugIds_interactionList_grade3}    symptom=

# 1.48 人群禁忌grade=0,用药审核结果为'通过'
#     [Documentation]    断言error:"safeStatus=3"
#     安全用药    ['body']['safeStatus']    3
#     ...    gender=    age=    ageType=    drugIds=${drugIds_tabooList_grade0}    symptom=
...
1.49 无高血压重复用药不同分组,用药审核结果为'通过'
    [Documentation]    断言error:"safeStatus=3"
    安全用药    ['body']['safeStatus']    3
    ...    gender=1    age=    ageType=    drugIds=${drugIds_repetitionList0}    symptom=
...
1.50 相互作用=0,人群禁忌=0,无高血压重复用药,用药审核结果为'通过'
    [Documentation]    断言error:"safeStatus=3"
    安全用药    ['body']['safeStatus']    3
    ...    gender=1    age=    ageType=岁    drugIds=${drugIds_interactionList_grade0_tabooList_grade0_repetitionList2}    symptom=
...
#        [Documentation]    断言error:""
#     安全用药    ['body']['safeStatus']    3
#        ...    gender=    age=    ageType=岁    drugIds=${drugIds_tabooList_grade0}   symptom=
# 1.57安全用药,填写年龄:月,提交成功
#        [Documentation]    断言error:""
#     安全用药    ['body']['safeStatus']    3
#        ...    gender=    age=    ageType=月    drugIds=${drugIds_tabooList_grade0}   symptom=
# 1.58安全用药,填写年龄:天,提交成功
#        [Documentation]    断言error:""
#     安全用药    ['body']['safeStatus']    3
#        ...    gender=    age=    ageType=天    drugIds=${drugIds_tabooList_grade0}   symptom=
# 1.59安全用药,填写患者主诉提交成功
#        [Documentation]    断言error:""
#     安全用药    ['body']['safeStatus']    3
#        ...    gender=    age=    ageType=    drugIds=${drugIds_tabooList_grade0}   symptom=头疼
# 1.60安全用药,全部填写提交成功
#        [Documentation]    断言error:""
#     安全用药    ['body']['safeStatus']    3
#        ...    gender=    age=    ageType=岁    drugIds=${drugIds_tabooList_grade0}    symptom=头疼
