...
#     智能诊断0    "uuid": "8654C0AFE1"    symptom=发热,胃痛,腹胀,腹痛,高热    previousHistory=    personalHistory=    allergyHistory=    familyHistory=
...
2.1 只填写主诉
    ...
    智能诊断    ['id']    ${10186}    symptom=发热,胃痛,腹胀,腹痛,高热    previousHistory=    personalHistory=    allergyHistory=    familyHistory=
    ...    weight=    gender=    bodyTempr=    lowBldPress=    highBldPress=    examInfo=
    ...    heartRate=    age=    ageType=    confirmDiagnosis=    confirmDiagnosisMap=    presentHistory=
...
2.2 体格检查_体温>=37.5
    ...
    智能诊断    ['id']    ${34051}    symptom=    previousHistory=
...
2.3 体格检查_体温>39
    ...
    智能诊断    ['id']    ${58}    symptom=    previousHistory=
...
2. 4体格检查_心率<60,心率过慢
    ...
    智能诊断    ['id']    ${7977}    symptom=    previousHistory=
...
2.5 体格检查_心率>100,心率过快
    ...
    智能诊断    ['id']    ${16804}    symptom=    previousHistory=
...
2.6 体格检查_收缩压>=140/90,高血压
    ...
    智能诊断    ['id']    ${40031}    symptom=    previousHistory=
