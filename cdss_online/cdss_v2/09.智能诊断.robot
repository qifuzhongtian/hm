...
2.1智能诊断接口_测试
    [Documentation]    断言:""
    智能诊断    ['body']['suspectedDiseases'][0]['id']    324386    symptom=发热,胃痛,腹胀,腹痛,高热    previousHistory=    personalHistory=    allergyHistory=    familyHistory=
...
# 2.4智能诊断接口_体格检查_心率<60,心率过慢
#     [Documentation]    断言:""
#     智能诊断2.2    ['body']['suspectedDiseases'][0]['id']    7977    symptom=    previousHistory=
...
# 2.5智能诊断接口_体格检查_心率>100,心率过快
#     [Documentation]    断言:""
#     智能诊断2.2    ['body']['suspectedDiseases'][0]['id']    16804    symptom=    previousHistory=
...
# 2.6智能诊断接口_体格检查_收缩压>=140/90,高血压
#     [Documentation]    断言:"高血压id"
#     智能诊断2.2    ['body']['suspectedDiseases'][0]['id']    40031    symptom=    previousHistory=
...
# 2.7智能诊断接口_体格检查_收缩压<90/60,低血压
#     [Documentation]    断言:""
#     智能诊断2.2    ['body']['suspectedDiseases'][0]['id']    15186    symptom=    previousHistory=
