...
VTE4.0:深静脉血栓(DVT)Wells评分 规则ID：vteDVT-1
    ...
    ...    doctorGuid=0210497    doctorName=测试医生    admissionTime=2019-12-12    inpatientDepartment=    patientInfo={"gender":"1","age":"19","ageType":"岁","maritalStatus":"1","pregnancyStatus":"0"}    physicalSign={"bodyTempr": "","heartRate": "","lowBldPress": "","highBldPress": ""}
...
VTE4.0:深静脉血栓(DVT)Wells差异对比
    ...
    ...    doctorGuid=1    doctorName=测试医生    admissionTime=2019-12-12    inpatientDepartment=    patientInfo={"gender":"1","age":"19","ageType":"岁","maritalStatus":"1","pregnancyStatus":"0"}    physicalSign={"bodyTempr": "","heartRate": "","lowBldPress": "","highBldPress": ""}
