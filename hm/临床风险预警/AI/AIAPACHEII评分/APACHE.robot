...
APACHE II-APACHE#AI评分大于8分，推荐APACHE II评分表 规则ID APA-1
    ...
    ...    doctorGuid=0210497    doctorName=测试医生    admissionTime=${time}    inpatientDepartment=重症医学科    patientInfo={"gender":"0","age":"76","ageType":"岁","maritalStatus":"1","pregnancyStatus":"0"}    physicalSign={"bodyTempr": "","heartRate": "","lowBldPress": "","highBldPress": ""}
    ...
    ...    inpatientArea=内科1病区    patientInfo={"gender":"0","age":"76","ageType":"岁"}    labTestList={"labTestNumber":"2373092","labTestName":"白细胞计数(WBC)","labTestSample":"血液","sampleCollectTime":"${time}","recordTime":"${time}","labTestItems":[{"labTestItemName":"白细胞计数","labTestResult":"41","labTestValueUnit":"10^9/L","labTestValueChange":"","labTestMethod":${null},"normalRange":" "}]}
