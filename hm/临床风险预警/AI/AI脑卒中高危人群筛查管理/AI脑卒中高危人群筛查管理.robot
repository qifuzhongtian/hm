...
脑卒中高危人群筛查管理，规则ID：STROKE-1
    ...
    ...    doctorGuid=0210497    doctorName=测试医生    admissionTime=${time}    inpatientDepartment=    patientInfo={"gender":"1","age":"19","ageType":"岁","maritalStatus":"1","pregnancyStatus":"0"}    physicalSign={"bodyTempr": "","heartRate": "","lowBldPress": "","highBldPress": ""}
