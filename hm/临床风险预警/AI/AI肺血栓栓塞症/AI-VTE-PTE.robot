...
HMvtePTE-17:PTE出院诊断 规则ID：HMvtePTE-17
    ...
    ...    openInterdict=${1}    examinationList={"examinationDesc":"","examinationName":"","examinationNumber":"eac0cb10-7665-11eb-9afa-4fdd682319be","examinationResult":"肺动脉栓塞","recordTime":"2021-02-24 10:11:51","reportTime":"2021-02-24 10:11:51"}
    ${getRes}    智能推荐v2    userGuid=${userGuid}    serialNumber=${serialNumber}    patientName=tester    pageSource=2    requestSource=
