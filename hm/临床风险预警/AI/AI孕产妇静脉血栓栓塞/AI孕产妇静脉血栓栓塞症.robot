...
VTE5.5-孕产妇静脉血栓栓塞 HM孕产妇静脉血栓栓塞风险因素评分（上海）≥3分 推外科出血风险评估规则ID vte5-1-SHRS
    ...
    ...    doctorGuid=1    doctorName=测试医生    admissionTime=${time_now}    inpatientDepartment=    patientInfo={"gender":"2","age":"19","ageType":"岁","maritalStatus":"1","pregnancyStatus":"0"}    physicalSign={"bodyTempr": "","heartRate": "","lowBldPress": "","highBldPress": ""}
