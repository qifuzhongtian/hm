...
*** Test Cases ***
KDIGO-AKI诊断,AI识别结果：符合，推出:KDIGO-AKI诊断评估表 规则ID KDIGO-1
    ...
    ...    labTestList={"labTestNumber":2226425,"labTestName":"血生化","labTestSample":"全血","sampleCollectTime":"${time_now}","recordTime":"${time_now}","labTestItems":[{"labTestItemName":"肌酐","labTestResult":"135","labTestValueUnit":"μmol/L","labTestValueChange":"","labTestMethod":"","normalRange":"30-110"}]},{"labTestNumber":2226426,"labTestName":"血生化","labTestSample":"全血","sampleCollectTime":"${admissionTime}","recordTime":"${admissionTime}","labTestItems":[{"labTestItemName":"肌酐","labTestResult":"75","labTestValueUnit":"μmol/L","labTestValueChange":"","labTestMethod":"","normalRange":"30-110"}]}
