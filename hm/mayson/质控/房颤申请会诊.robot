...
房颤申请会诊
    ...
    ${getRes}    房颤申请会诊    userGuid=${userGuid}    serialNumber=${serialNumber}        recordId=${recordId}    ruleNumber=AF-8    ruleRemark=【呼吸科科室】tester（患者id：1590050740986）诊断房颤，CHA2DS2-VASc评分=3分，于05月21日16时申请会诊
    ...    warnLevel=3    type=1    receiver=18232243607    projectId=1151    projectName=血栓高风险请心脏科会诊
    ...    qcDiseaseDiagnosisList={"diseaseId":1003,"versionInfo":""}
    #####推荐检查评估表
