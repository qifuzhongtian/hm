...
卡控合并：saveAndTurn接口
    ...
    ${getRes}    卡控合并    alertLevel=${1}    assessDictName=Caprini评分    assessId=440    assessName=外科VTE风险评估(Caprini评分表)    assessResult=低危    assessResultItemList=    assessResultStyle=${1}
