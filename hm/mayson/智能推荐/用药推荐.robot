...
mayson用药推荐
    ...
    ...    doctorName=测试医生    admissionTime=2018-12-12    inpatientDepartment=儿科    pageSource=2    requestSource=    patientInfo={"gender":"1","age":"60","ageType":"岁","maritalStatus":"1","pregnancyStatus":"0"}    physicalSign={"bodyTempr": "","heartRate": "","lowBldPress": "","highBldPress": ""}
