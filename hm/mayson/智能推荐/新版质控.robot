...
新版质控:社区获得性肺炎-小儿,推出质控推荐检查,首次病程,推出检查:社区获得性肺炎患儿病情严重度评估
    [Setup]    Run Keywords    获取时间戳
    ...    AND    获取随机数
    # ${timestamp}    Get Time    epoch
    ${Assessment}    Set Variable    社区获得性肺炎
...
新版质控:脑梗死,推出质控评估表,首次病程,推出评估表:NIHSS卒中量表
    [Setup]    Run Keywords    获取时间戳
    ...    AND    获取随机数
    # ${timestamp}    Get Time    epoch
...
新版质控:短暂性脑缺血发作,推出质控评估表,首次病程,推出评估表:NIHSS卒中量表
    [Setup]    Run Keywords    获取时间戳
    ...    AND    获取随机数
    # ${timestamp}    Get Time    epoch
...
新版质控:VTE,推出质控评估表,首次病程,手术患者深静脉血栓栓塞症风险评估表(Caprini评分表)
    [Setup]    Run Keywords    获取时间戳
    ...    AND    获取随机数
    # ${timestamp}    Get Time    epoch
    ${tm}    get_current_date
