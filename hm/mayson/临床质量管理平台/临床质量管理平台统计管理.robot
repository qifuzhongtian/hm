...
*** Test Cases ***
临床质量管理平台统计管理
    [Documentation]    :3016/statistic/relationDic
...
临床质量管理平台出院人次
    [Documentation]    :3016/statistic/patientVisitData
...
临床质量管理平台主管医生
     [Documentation]    :3016/statistic/patientDoctor
