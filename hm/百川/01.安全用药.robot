...
1.2 相互作用等级为'禁用'的两种药,grade=1
    ...
    ...    # drugIds=${drugIds}    symptom=    confirmDiagnosis=
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=5    ageType=    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=2    ageType=    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
...
#     #    ${drugCommonNames}    Create List
#     #    ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=12    ageType=岁
#     ...    # drugIds=${drugIds}    symptom=    confirmDiagnosis=
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=0    age=    ageType=    drugIds=${drugIds}
#     ...    symptom=妊娠    confirmDiagnosis=
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=0    age=4381    ageType=天    drugIds=${drugIds}
#     ...    symptom=备孕    confirmDiagnosis=
...
#     ${drugIds}    Create List    579
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=10    ageType=岁    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=30    ageType=天    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
...
#     ${drugIds}    Create List    139
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=4382    ageType=天    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
...
#     #    ${drugCommonNames}    Create List
#     #    ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=43799    ageType=天
#     ...    # drugIds=${drugIds}    symptom=    confirmDiagnosis=
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=0    age=22    ageType=岁    drugIds=${drugIds}
#     ...    symptom=妊娠    confirmDiagnosis=
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=0    age=43800    ageType=天    drugIds=${drugIds}
#     ...    symptom=未婚    confirmDiagnosis=
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=0    age=2459    ageType=天    drugIds=${drugIds}
#     ...    symptom=未婚    confirmDiagnosis=
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=1    age=    ageType=    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
...
#     ${drugIds}    Create List    212    5773
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=1    age=50    ageType=岁    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
...
#     ${drugIds}    Create List    5647
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=55    ageType=岁    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=3    ageType=月    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
#     Should Be Equal As Strings    ${getRes['body']['safeStatus']}    1
#     ################################待审核
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=0    age=20    ageType=岁    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
#     Should Be Equal As Strings    ${getRes['body']['safeStatus']}    2
...
#     ${drugIds}    Create List    212    5773
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=22    ageType=岁    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
#     Should Be Equal As Strings    ${getRes['body']['safeStatus']}    2
...
#     #    ${drugCommonNames}    Create List
#     #    ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=50    ageType=岁
#     ...    # drugIds=${drugIds}    symptom=    confirmDiagnosis=
#     #    Should Be Equal As Strings    ${getRes['body']['safeStatus']}    2
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=0    age=50    ageType=岁    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
#     Should Be Equal As Strings    ${getRes['body']['safeStatus']}    2
...
#     ${drugIds}    Create List    579
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=3    ageType=    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
#     Should Be Equal As Strings    ${getRes['body']['safeStatus']}    2
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=1    age=    ageType=岁    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=
#     Should Be Equal As Strings    ${getRes['body']['safeStatus']}    3
...
#     ${drugIds}    Create List    930
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=0    age=22    ageType=    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=13895
#     Should Be Equal As Strings    ${getRes['body']['tabooList']}    []
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=0    age=    ageType=    drugIds=${drugIds}
#     ...    symptom=    confirmDiagnosis=14234
#     Should Be Equal As Strings    ${getRes['body']['tabooList'][0]['description']}    3个月以上孕妇慎用
...
#     ...    # drugIds=${drugIds}    symptom=肌酐清除率=20ml/min    confirmDiagnosis=
...
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=0    age=23    ageType=    drugIds=${drugIds}
#     ...    symptom=妊娠4个月    confirmDiagnosis=1,3,4
#     Should Be Equal As Strings    ${getRes['body']['tabooList'][0]['description']}    3个月以上孕妇慎用
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=    ageType=    drugIds=${drugIds}
#     ...    symptom=Roemheld综合症    confirmDiagnosis=
#     Should Be Equal As Strings    ${getRes['body']['tabooList'][0]['grade']}    1
...
#     ${drugCommonNames}    Create List
#     ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=    ageType=    drugIds=${drugIds}
#     ...    symptom=肾功能损害（肌酐清除率<25ml/分）    confirmDiagnosis=
#     Should Be Equal As Strings    ${getRes['body']['tabooList'][0]['grade']}    1
...
#     #    ${drugCommonNames}    Create List
#     #    ${getRes}    安全用药    drugCommonNames=${drugCommonNames}    gender=    age=    ageType=
#     ...    # drugIds=${drugIds}    symptom=肌酐清除率24ml/分    confirmDiagnosis=
#     #    Should Be Equal As Strings    ${getRes['body']['tabooList'][0]['grade']}    1
