...
2.1 只填写主诉
    ...
    ...    # presentHistory=
    智能诊断1    ['diseaseName']    ${10186}    symptom=发热,胃痛,腹胀,腹痛,高热    previousHistory=    personalHistory=    allergyHistory=
...
2.2 体格检查_体温>=37.5
    [Documentation]    断言:"存在急性上呼吸道感染id"
    智能诊断    ['id']    ${34051}    symptom=    previousHistory=    personalHistory=    allergyHistory=
...
2.3 体格检查_体温>39
    ...
    智能诊断    ['id']    ${58}    symptom=    previousHistory=    personalHistory=    allergyHistory=
...
2. 4体格检查_心率<60,心率过慢
    ...
    智能诊断    ['id']    ${7977}    symptom=    previousHistory=    personalHistory=    allergyHistory=
    ...    familyHistory=    weight=    gender=    bodyTempr=    lowBldPress=    highBldPress=
...
2.5 体格检查_心率>100,心率过快
    ...
    智能诊断    ['id']    ${16804}    symptom=    previousHistory=    personalHistory=    allergyHistory=
    ...    familyHistory=    weight=    gender=    bodyTempr=    lowBldPress=    highBldPress=
...
2.6 体格检查_收缩压>=140/90,高血压
    ...
    智能诊断    ['id']    ${40031}    symptom=    previousHistory=    personalHistory=    allergyHistory=
