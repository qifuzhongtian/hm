...
# 字段名 类型  说明
# inquiryType  Integer  是  0：初诊  1：复诊
# address
# recordId    Long    病历ID
# patientId   Long    患者ID
...
12.1 保存病历
   # [Documentation]    断言:"error=0 成功"
    ${getRes}    保存病历_输液卡    inquiryType=0    address=测试地址    recordId=${recordId}    patientId=${patientId}    patientName=接口自动保存病例    gender=1    age=50
    ...
    ...    patentPrescriptionList={"isCharged":${0},"prescription":${null},"patentDrugList":[{"drugId":"29087","drugName":"萃仙丸","dataSource":"1","assId":"","usage":"口服","frequency":"1日2次(bid)","dosage":"1","dosageUnit":"粒","totalDosage":2,"totalDosageUnit":"盒","price":2,"univalence":1,"prescription":${null},"specification":"每100粒重3g","manufacturer":"本溪仙草堂药业有限公司"}]}
    # ...    patentPrescriptionList=
    # ...    chinesePrescriptionList={"isCharged":${0},"prescription":${null},"totalDosage":3,"dailyDosage":"1","frequency":"1日1次(qd)","usage":"口服","requirement":"水煎400ml；分早晚两次空腹温服","prescription":${null},"decoctionPiecesList":[{"drugId":"18939","drugName":"胖大海","value":1,"unit":"盒","price":1,"comment":"先煎","univalence":2.22,"dataSource":"1","specification":"1.0g/粒*20/盒"}]}
...
#    # [Documentation]    断言:"error=0 成功"
#     ${getRes}    保存病历_输液卡    recordId=${recordId}    patientId=${patientId}    patientName=接口自动补录病例    gender=1    age=50
#     ...    ageType=岁    phoneNo=1333333333    temperature=37    sbp=130    dbp=90    heartRate=90
#     ...    height=181    weight=71.5    otherPhysique=
...
#     # ...    additionalList={"additionalId":${null},"additionalName":"附加费用1","additionalPrice":"1.00","isCharged":"0"},{"additionalId":${null},"additionalName":"附加费用2","additionalPrice":"2.00","isCharged":"0"}
#     ...    infusionList={"usage":"口服","useRate":"每日一次","drippingSpeed":0.5,"speedUnit":"0.5mg/s","startTime":"2017-07-05","dayCount":5,"group":"","delFlag":"N","patientDrugList":[{"id":"","drugId":"","drugName":"青霉素V钾片","dosage":"1","dosageUnit":"滴","totalDosage":1,"totalDosageUnit":"盒","dataSource":1,"price":1.00}]}
#     Should Be Equal As Strings    ${getRes['head']['error']}    0
